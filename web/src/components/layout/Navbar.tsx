      ...
      <div className="max-w-7xl mx-auto px-8 relative" style={{ zIndex: 10 }}>
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center">
            <Link
              to="/"
              className="text-xl font-semibold text-gray-900 dark:text-base-content flex items-center gap-2"
            >
              Antigravity Tools
            </Link>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              title={
                config?.theme === "light" ? "切换到深色模式" : "切换到浅色模式"
              }
            >
              {config?.theme === "light" ? (
            ...
            <button
              ...
              className="w-10 h-10 rounded-full bg-gray-100 dark:bg-base-200 hover:bg-gray-200 dark:hover:bg-base-100 flex items-center justify-center transition-colors"
              title={
                config?.language === "zh" ? "Switch to English" : "切换到中文"
              }
            >
