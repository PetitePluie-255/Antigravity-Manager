...
interface AccountTableProps {
  ...
  onDeviceManage?: (accountId: string) => void;
}
      ...
      <table className="w-full">
        <thead>
          <tr className="border-b border-gray-100 dark:border-base-200 bg-gray-50 dark:bg-base-200">
            ...
            <th className="px-4 py-1 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider whitespace-nowrap">
              {t("accounts.table.email")}
            </th>
            <th className="px-4 py-1 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider w-[440px] whitespace-nowrap">
        ...
        <tbody className="divide-y divide-gray-100 dark:divide-base-200">
          {accounts.map((account) => (
            <AccountRow
              ...
              onDeviceManage={
                onDeviceManage ? () => onDeviceManage(account.id) : undefined
              }
            />
          ))}
        </tbody>
