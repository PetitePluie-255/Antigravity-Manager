    ...
    >
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              ...
              {account.quota?.is_forbidden && (
                <span
                  className="px-1.5 py-0.5 rounded-md bg-red-100 dark:bg-red-900/40 text-red-600 dark:text-red-400 text-[9px] font-bold flex items-center gap-1 shadow-sm border border-red-200/50"
            ...
            <div className="grid grid-cols-2 gap-1.5">
              ...
              <div className="relative h-[26px] flex items-center px-1 rounded-lg overflow-hidden border border-gray-100/50 dark:border-white/5 bg-gray-50/30 dark:bg-white/5 group/quota">
                ...
                <div className="relative z-10 w-full flex items-center text-[9px] font-mono leading-none whitespace-nowrap">
                  <span
                    className="w-[46px] text-gray-500 dark:text-gray-400 font-bold truncate pr-0.5"
                    title="Gemini 3 Pro"
                  >
                    G3 Pro
                  </span>
                  <div className="flex-1 flex justify-center overflow-hidden">
                    {geminiProModel?.reset_time ? (
                      <span
                        className={cn(
                          "flex items-center gap-0.5 font-medium transition-colors whitespace-nowrap",
                  ...
                  <span
                    className={cn(
                      "w-[30px] text-right font-bold transition-colors shrink-0",
      ...
      <div className="flex-none flex items-center justify-between pt-2 border-t border-gray-100 dark:border-base-200">
        <span className="text-[10px] text-gray-400 dark:text-gray-500 font-mono">
          {new Date(account.last_used * 1000).toLocaleString([], {
            year: "numeric",
            month: "2-digit",
            day: "2-digit",
            hour: "2-digit",
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            className={`p-1.5 rounded-lg transition-all ${
              isSwitching
                ? "text-blue-600 bg-blue-50 dark:text-blue-400 dark:bg-blue-900/10 cursor-not-allowed"
