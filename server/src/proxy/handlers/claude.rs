...
fn is_warmup_request(request: &crate::proxy::mappers::claude::models::ClaudeRequest) -> bool {
...
/// 
/// 返回一个简单的响应，不消耗上游配额
fn create_warmup_response(request: &crate::proxy::mappers::claude::models::ClaudeRequest, is_stream: bool) -> Response {
    use axum::body::Body;
